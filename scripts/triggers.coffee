...
triggers =
  ...
  '!usedev'       : "Only use the dev version if you don't mind potentially needing to change your app on updates if the API or concepts change. Stability is not guaranteed nor likely."
  ...
  '!phrasing'     : "Phrasing! http://batdoc.files.wordpress.com/2012/03/archer-1-phrasing.jpg?w=604"

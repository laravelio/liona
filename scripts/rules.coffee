...
RULES =
  ...
  nopb:      "Do not use any paste service that is not http://laravel.io/bin, https://gist.github.com, or http://kopy.io to post code. Pastebin, for example has a tiny font and it has ads on it which cause the page to load slowly. Other paste services generally look like crap."
